...
pull:
	...
	docker pull devbens/hello-world
	docker pull portainer/portainer-ce
	docker pull portainer/agent
	docker pull devbens/workspace

traefik: init stack pull
	docker stack deploy -c deploy/stack-traefik.yml bens
	docker stack deploy -c deploy/stack-hello-world.yml bens
	docker stack deploy -c deploy/stack-portainer-agent.yml bens

workspace: traefik
	docker stack deploy -c deploy/stack-portainer.yml bens
	docker stack deploy --resolve-image never -c deploy/stack-workspace.yml bens
